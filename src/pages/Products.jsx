...
const Products = () => {
  ...
  const productTwo = {
    ...
    carouselImages: ["/pp/PP-1.jpg", "/pp/PP-2.jpeg", "/pp/PP-3.jpeg", "/pp/PP-4.jpeg"],
    keyFeatures: [
      "/product/key-1.jpg",
      "/product/key-2.jpg",
      "/product/key-3.jpg",
  ...
  const productThree = {
    ...
    tableHeaders: ["SIZE (MM)", "WEIGHT/220METER (KGS)", "BREAKING STRENGTH MIN(KGF)"],
    tableData: [
      ["6", "5.9", "560"],
      ["8", "10.5", "1020"],
      ["10", "16.7", "1590"],
  ...
  const productFour = {
    ...
    tableData: [
      ["6", "1/4", "3/4", "3.92", "3.56", "8.62", "7.83", "400", "880", "4.31", "440"],
      ["7", "9/32", "7/8", "5.35", "4.86", "11.76", "10.69", "600", "1320", "5.69", "500"],
      ["8", "5/16", "1", "6.97", "6.34", "15.34", "13.95", "700", "1540", "7.35", "500"],
      ["9", "3/8", "1-1/8", "8.82", "8.02", "19.41", "17.64", "900", "1980", "9.12", "500"],
      ["10", "13/32", "1-1/4", "10.89", "9.90", "23.96", "21.78", "1100", "2420", "11.10", "450"],
      ["11", "7/16", "1-3/8", "13.20", "12.00", "29.04", "26.40", "1300", "2860", "13.20", "365"],
      ["12", "15/32", "1-1/2", "15.73", "14.30", "34.61", "31.46", "1700", "3740", "16.30", "250"],
      ["13", "1/2", "1-5/8", "18.04", "16.40", "39.69", "36.08", "1900", "4180", "18.70", "2000"],
      ["14", "9/16", "1-3/4", "20.90", "19.00", "45.98", "41.80", "2200", "4840", "21.70", "2000"],
      ["16", "5/8", "2", "27.50", "25.00", "60.50", "55.00", "2800", "6160", "27.80", "1500"],
      ["18", "23/32", "2-1/4", "34.65", "31.50", "76.23", "69.30", "3500", "7700", "34.50", "1200"],
      ["19", "3/4", "2-3/8", "38.72", "35.20", "85.18", "77.44", "3900", "8580", "38.30", "1000"],
      ["20", "13/16", "2-1/2", "42.90", "39.00", "94.38", "85.80", "4300", "9460", "42.10", "900"],
      ["22", "7/8", "2-3/4", "52.28", "47.40", "114.95", "104.80", "5100", "11220", "50.20", "700"],
      ["24", "15/16", "3", "62.15", "56.50", "136.73", "124.30", "6000", "13200", "59.00", "600"],
      ["25", "1", "3-1/8", "67.10", "61.00", "147.62", "134.20", "6500", "14300", "63.30", "500"],
      [
        "26",
        "1-1/32",
        "3-1/4",
  ...
  const twineTypes = [
    {
      name: "HDPE TWINE",
      images: [
        "twines/hd-twine-1.jpg",
        "twines/hd-twine-2.jpg",
        "twines/hd-twine-3.jpg",
        "twines/hd-twine-4.jpg",
      ],
    },
    {
      name: "BRAIDED TWINE",
      images: [
        "twines/br-twine-1.jpg",
        "twines/br-twine-2.jpg",
        "twines/br-twine-3.jpg",
        "twines/br-twine-4.jpg",
      ],
    },
    {
      name: "BALLER TWINE",
